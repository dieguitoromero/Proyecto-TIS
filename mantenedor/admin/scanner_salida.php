<html>
  <head>
    <title>QRCode Scanner Salida</title> 
     <!-- Bootstrap CSS -->
  ...
  <div class="container">
    <div class="row justifity-content-center text-center mt-5">
      <h2 class="mb-5">Escanee el codigo para registrar la salida</h2>
      <video id="preview" width='400' height='300'></video>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-6">
            <form action="funciones/salir.php" method="POST" class="form-control text-center mt-3">
